...
import { v as Subscribable, w as pendingThenable, x as resolveEnabled, y as shallowEqualObjects, z as resolveStaleTime, A as noop, C as environmentManager, D as isValidTimeout, E as timeUntilStale, F as timeoutManager, G as focusManager, H as fetchState, I as replaceData, J as notifyManager, K as hashKey, N as getDefaultState, r as reactExports, O as shouldThrowError, Q as useQueryClient, j as jsxRuntimeExports, g as cn } from "./index-BTYXqmFh.js";
...
const SEED_PRODUCTS = [
  {
    ...
    description: "Ultra-slim quartz watch with stainless steel strap. Perfect for everyday wear.",
    category: "Watches",
    commission: 300,
    createdAt: Date.now()
  },
  {
    ...
    description: "Lightweight mesh upper with cushioned sole for maximum comfort during runs.",
    category: "Shoes",
    commission: 200,
    createdAt: Date.now()
  },
  {
    ...
    description: "High-definition sound with powerful bass, inline mic, and tangle-free cable.",
    category: "Gadgets",
    commission: 150,
    createdAt: Date.now()
  },
  ...
  },
  {
    ...
    sizes: ["Free Size"],
    colors: ["Black", "Blue"],
    description: "Track steps, heart rate, sleep, and calories. Compatible with iOS & Android.",
    category: "Gadgets",
    commission: 250,
    createdAt: Date.now()
  },
  {
    ...
    description: "Elegant printed cotton kurta with matching palazzo. Festive & casual ready.",
    category: "Clothes",
    commission: 180,
    createdAt: Date.now()
  }
