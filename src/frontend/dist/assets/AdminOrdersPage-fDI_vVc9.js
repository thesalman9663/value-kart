import { c as createLucideIcon, R as React2, m as useComposedRefs, j as jsxRuntimeExports, r as reactExports, o as reactDomExports, g as cn, S as ShoppingBag, B as Badge, a as Button } from "./index-BTYXqmFh.js";
import { j as useOrders, n as useUpdateOrderStatus, C as Card, a as CardContent } from "./useBackend-VDAK0KUu.js";
import { e as createContextScope, g as createSlot, P as Primitive, u as useLayoutEffect2, j as useCallbackRef, a as useControllableState, b as useId, c as composeEventHandlers, d as Portal$1, h as hideOthers, f as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer } from "./index-B9qoHkp1.js";
...
function AdminOrdersPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin_orders.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-xl text-foreground", children: "Orders" }),
    ...
    ) : !(orders == null ? void 0 : orders.length) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", "data-ocid": "admin_orders.empty_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "w-10 h-10 text-muted-foreground mx-auto mb-3 opacity-40" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "No orders yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Orders will appear here once customers place them" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "admin_orders.list", children: orders.map((order, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { "data-ocid": `admin_orders.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-2 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs font-semibold text-foreground bg-muted px-2 py-0.5 rounded", children: order.id }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: ORDER_STATUS_STYLES[order.orderStatus], children: order.orderStatus }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: order.customerName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: order.customerPhone }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground line-clamp-1 mt-0.5", children: order.customerAddress })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: order.paymentMethod })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          ...
          order.deliveredAt && ` · Delivered: ${new Date(order.deliveredAt).toLocaleDateString("en-IN", { day: "2-digit", month: "short" })}`
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row sm:flex-col gap-2 sm:min-w-[150px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
        ...
        order.orderStatus !== "delivered" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            size: "sm",
            variant: "outline",
